...
export default function Projects() {
  return (
    <section id="projects" className="text-black bg-red-200 body-font">
            ...
            <a
              ...
              <div className="flex relative">
                <img
                  ...
                  src={project.image}
                />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-purple-200 bg-purple-200 opacity-0 hover:opacity-100 rounded">
